import { Q as reactExports, E as isPromise, F as isRedirect, C as isNotFound, A as invariant, h as createControlledPromise, Z as rootRouteId, G as isServer$1, v as functionalUpdate$1, c as arraysEqual, i as createLRUCache, f as compileDecodeCharMap, $ as trimPath, Y as rewriteBasepath, g as composeRewrites, P as processRouteTree, N as processRouteMasks, X as resolvePath, e as cleanPath, a1 as trimPathRight, M as parseHref, q as executeRewriteInput, B as isDangerousProtocol, S as redirect, u as findSingleMatch, l as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, d as buildRouteBranch, z as interpolatePath, L as nullReplaceEqualDeep, U as replaceEqualDeep$1, J as last, k as decodePath, s as findFlatMatch, t as findRouteMatch, y as hasKeys, r as executeRewriteOutput, n as encodePathLikeUrl, a0 as trimPathLeft, H as joinPaths, a3 as useRouter, m as dummyMatchContext, K as matchContext, V as requireReactDom, p as exactPathTest, T as removeTrailingSlash, R as React, I as jsxRuntimeExports, a2 as useHydrated, o as escapeHtml, w as getAssetCrossOrigin, x as getScriptPreloadAttrs, b as appendUniqueUserTags, W as resolveManifestCssLink, O as Outlet, a as React$1 } from "./server-C6ZeWB5P.js";
...
function buildTagsFromMatches(router, nonce, matches, assetCrossOrigin) {
  const routeMeta = matches.map((match) => match.meta).filter((meta2) => meta2 !== void 0);
  const resultMeta = [];
...
const repos$1 = { "frontend": "https://github.com/extremexp-HORIZON/vis-frontend", "api": "https://github.com/extremexp-HORIZON/vis-api", "explain": "https://github.com/extremexp-HORIZON/extremexp-explainability-module" };
...
function KubeflowBadge() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 inline-flex items-center rounded-full bg-indigo-50 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-indigo-700 ring-1 ring-inset ring-indigo-700/10", children: t$2.deep.kubeflowBadge });
}
function FeaturesPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white text-slate-900", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Nav$1, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturesHero, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureShowcase, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DeepFeatures, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CTA, {})
  ] });
}
function Nav$1() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 border-b border-slate-200/70 bg-white/80 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base font-semibold tracking-tight", children: common.brand })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-7 text-sm text-slate-600 md:flex", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/features", className: "font-medium text-slate-900", children: common.nav.features }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/docs", className: "hover:text-slate-900", children: common.nav.docs })
    ] }),
...
function FeaturesHero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-b border-slate-200 bg-gradient-to-b from-sky-50/60 via-white to-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-6 py-16 text-center md:py-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-sky-600", children: t$2.hero.eyebrow }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-2 text-4xl font-semibold tracking-tight sm:text-5xl", children: t$2.hero.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "p",
      {
        className: "mt-4 text-lg leading-relaxed text-slate-600",
        dangerouslySetInnerHTML: { __html: t$2.hero.subtitle }
      }
    )
  ] }) });
}
function FeatureShowcase() {
  const features = t$2.showcase.features.map((f) => ({
    eyebrow: f.eyebrow,
    title: f.title,
    body: f.body,
    bullets: f.bullets,
    image: IMAGES$1[f.image]
  }));
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-b border-slate-200 bg-slate-50/60 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader$1,
      {
        eyebrow: t$2.showcase.eyebrow,
        title: t$2.showcase.title,
        subtitle: t$2.showcase.subtitle
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(StickyFeatureScroller, { features })
  ] }) });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0", children: features.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ref: (node) => {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-sky-600", children: f.eyebrow }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl", children: f.title }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base leading-relaxed text-slate-600", children: f.body }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-5 space-y-2 text-sm text-slate-700", children: f.bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "mt-0.5 h-4 w-4 flex-none text-emerald-500" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: b })
                    ] }, b)) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center gap-2 text-xs font-medium text-slate-500", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tabular-nums", children: String(i + 1).padStart(2, "0") }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-px w-8 bg-slate-300" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "tabular-nums", children: String(features.length).padStart(2, "0") })
                    ] })
                  ]
                }
              )
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-24 flex h-[calc(100vh-7rem)] items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[16/10] w-full", children: [
            features.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserFrame$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: f.image, alt: f.title, className: "block w-full" }) })
              },
              f.title
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-9 left-0 flex items-center gap-1.5", children: features.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 space-y-16 lg:hidden", children: features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-sky-600", children: f.eyebrow }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 text-2xl font-semibold tracking-tight text-slate-900 sm:text-3xl", children: f.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base leading-relaxed text-slate-600", children: f.body }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-5 space-y-2 text-sm text-slate-700", children: f.bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "mt-0.5 h-4 w-4 flex-none text-emerald-500" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: b })
      ] }, b)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserFrame$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: f.image, alt: f.title, className: "block w-full" }) }) })
    ] }, f.title)) })
  ] });
}
function BrowserFrame$1({ children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-xl border border-slate-200 bg-white shadow-2xl ring-1 ring-slate-900/5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 border-b border-slate-200 bg-slate-50 px-3 py-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-3 truncate text-[11px] text-slate-400", children: common.browserFrameUrl })
    ] }),
    children
  ] });
}
function DeepFeatures() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-b border-slate-200 bg-white py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader$1,
      {
        eyebrow: t$2.deep.eyebrow,
        title: t$2.deep.title,
        subtitle: t$2.deep.subtitle
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3", children: t$2.deep.items.map((item) => {
      const Icon2 = ICONS$2[item.icon];
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-9 w-9 place-items-center rounded-lg bg-slate-100 text-slate-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-slate-900", children: item.title }),
              item.kubeflowOnly && /* @__PURE__ */ jsxRuntimeExports.jsx(KubeflowBadge, {})
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm leading-relaxed text-slate-600", children: item.body })
          ]
        },
        item.title
      );
...
function CTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-slate-950 py-20 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl px-6 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-semibold tracking-tight sm:text-4xl", children: t$2.cta.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-base text-white/70", children: t$2.cta.subtitle }),
...
function SectionHeader$1({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-sky-600", children: eyebrow }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-2 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl", children: title }),
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-base leading-relaxed text-slate-600", children: subtitle })
  ] });
}
const Route$2 = createFileRoute("/features")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: t$2.meta.description },
      { property: "og:title", content: t$2.meta.ogTitle },
      { property: "og:description", content: t$2.meta.ogDescription }
    ]
  })
});
...
function DocsPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white text-slate-900", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-20 border-b border-slate-200 bg-white/80 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-14 max-w-7xl items-center justify-between px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          to: "/",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-2 text-sm font-semibold text-slate-900", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-4 w-4 text-sky-600" }),
        t$1.header.brand
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl grid-cols-12 gap-10 px-6 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "col-span-12 md:col-span-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "sticky top-20 space-y-6 text-sm", children: t$1.groups.map((group) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2 text-xs font-semibold uppercase tracking-widest text-slate-400", children: group }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: t$1.sections.filter((s) => s.group === group).map((s) => {
          const Icon2 = ICONS$1[s.icon];
          return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-3.5 w-3.5 text-slate-400" }),
                s.title
              ]
            }
          ) }, s.id);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "col-span-12 space-y-20 md:col-span-9", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-sky-600", children: t$1.intro.eyebrow }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-2 text-4xl font-semibold tracking-tight text-slate-900", children: t$1.intro.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-2xl text-base leading-relaxed text-slate-600", children: t$1.intro.body })
        ] }),
        t$1.docSections.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          DocSection,
          {
            id: s.id,
            eyebrow: s.eyebrow,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-slate-200 bg-slate-50 p-6 text-sm text-slate-600", children: t$1.placeholderNote })
      ] })
    ] })
  ] });
}
function DocSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id, className: "scroll-mt-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-sky-600", children: eyebrow }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-2 text-2xl font-semibold tracking-tight text-slate-900", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-2xl text-sm leading-relaxed text-slate-600", children: description }),
    subBlocks && subBlocks.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 space-y-4", children: subBlocks.map((title2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SubBlock, { title: title2 }, title2)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-xl border border-dashed border-slate-300 bg-slate-50 p-6 text-sm italic text-slate-400", children: t$1.emptySectionPlaceholder })
  ] });
}
function SubBlock({ title }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-slate-200 bg-white p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-slate-900", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs italic text-slate-400", children: t$1.subBlockPlaceholder })
  ] });
}
const Route$1 = createFileRoute("/docs")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: t$1.meta.description }
    ]
  })
});
...
function SlideRegistry(containSnaps, containScroll, scrollSnaps, scrollContainLimit, slidesToScroll, slideIndexes) {
  ...
  function createSlideRegistry() {
    ...
    return groupedSlideIndexes.slice(min, max).map((group, index, groups2) => {
      const isFirst = !index;
      const isLast = arrayIsLastIndex(groups2, index);
      if (isFirst) {
        const range = arrayLast(groups2[0]) + 1;
        return arrayFromNumber(range);
      }
      if (isLast) {
        const range = arrayLastIndex(slideIndexes) - arrayLast(groups2)[0] + 1;
        return arrayFromNumber(range, arrayLast(groups2)[0]);
      }
      return group;
    });
  }
...
function SlidesToScroll(axis, viewSize, slidesToScroll, loop, containerRect, slideRects, startGap, endGap, pixelTolerance) {
  ...
  function bySize(array) {
    ...
    return arrayKeys(array).reduce((groups2, rectB, index) => {
      ...
      if (index && chunkSize > viewSize + pixelTolerance) groups2.push(rectB);
      if (isLast) groups2.push(array.length);
      return groups2;
    }, []).map((currentSize, index, groups2) => {
      const previousSize = Math.max(groups2[index - 1] || 0);
...
function HomePage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-white text-slate-900", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ValueProps, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FeaturesPreview, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Integrations, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(HowItWorks, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DemoStrip, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Repos, {}),
...
function FeaturesPreview() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "features", className: "border-b border-slate-200 bg-white py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-5xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-sky-600", children: t.featuresPreview.eyebrow }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-2 text-3xl font-semibold tracking-tight text-slate-900 sm:text-4xl", children: t.featuresPreview.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-base leading-relaxed text-slate-600", children: t.featuresPreview.subtitle })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4 px-1 pb-4 sm:px-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "truncate text-base font-semibold text-slate-900 sm:text-lg", children: slides[selected]?.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1.5", children: slides.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Carousel,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselContent, { children: slides.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(CarouselItem, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserFrame, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: IMAGES[s.image], alt: s.title, className: "block w-full" }) }) }, s.title)) })
            }
          )
        ]
      }
...
function Nav() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-50 border-b border-slate-200/70 bg-white/80 backdrop-blur", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex h-16 max-w-7xl items-center justify-between px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden items-center gap-7 text-sm text-slate-600 md:flex", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/features", className: "hover:text-slate-900", children: common.nav.features }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/docs", className: "hover:text-slate-900", children: common.nav.docs })
    ] }),
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden border-b border-slate-200 bg-gradient-to-b from-sky-50/60 via-white to-white", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-0 [background:radial-gradient(60%_50%_at_50%_0%,rgba(56,189,248,0.18),transparent_70%)]" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto max-w-7xl px-6 pb-14 pt-16 md:pt-24", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-3xl text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-5 text-4xl font-semibold tracking-tight text-slate-900 sm:text-6xl", children: [
          t.hero.titlePre,
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-gradient-to-r from-sky-500 to-indigo-600 bg-clip-text text-transparent", children: t.hero.titleHighlight }),
          " ",
          t.hero.titlePost
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto mt-14 max-w-6xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -inset-x-10 -top-6 -bottom-6 -z-10 rounded-[2rem] bg-gradient-to-tr from-sky-200/40 via-indigo-200/30 to-fuchsia-200/30 blur-2xl" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserFrame, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: screenOverview,
            alt: t.hero.imageAlt,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-center text-xs italic text-slate-500", children: t.hero.imageCaption })
      ] })
    ] })
  ] });
}
...
function ValueProps() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "border-b border-slate-200 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid gap-6 md:grid-cols-3", children: t.valueProps.items.map(({ icon, title, body }) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-10 w-10 place-items-center rounded-lg bg-sky-50 text-sky-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-4 text-base font-semibold text-slate-900", children: title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm leading-relaxed text-slate-600", children: body })
          ]
        },
        title
      );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid gap-6 md:grid-cols-2", children: t.integrations.cards.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          IntegrationCard,
          {
            icon: ICONS[c.icon],
            tag: c.tag,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 text-center text-sm text-slate-500", children: t.integrations.footnote })
      ] })
    }
  );
}
function IntegrationCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-slate-200 bg-gradient-to-br from-white to-slate-50 p-7", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-11 w-11 place-items-center rounded-lg bg-slate-900 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-slate-400", children: tag }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-semibold text-slate-900", children: name })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-sm leading-relaxed text-slate-600", children: body }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-4 space-y-1.5 text-sm text-slate-700", children: points.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "mt-0.5 h-4 w-4 flex-none text-sky-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: p })
    ] }, p)) })
  ] });
}
function HowItWorks() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "how", className: "border-b border-slate-200 bg-slate-50/60 py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 grid gap-6 md:grid-cols-3", children: t.howItWorks.steps.map(({ n, icon, title, body }) => {
      const Icon2 = ICONS[icon];
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-4 top-4 text-xs font-mono text-slate-300", children: n }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid h-10 w-10 place-items-center rounded-lg bg-indigo-50 text-indigo-600", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-4 text-base font-semibold text-slate-900", children: title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm leading-relaxed text-slate-600", children: body })
          ]
        },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-12 rounded-2xl border border-slate-200 bg-white p-6 sm:p-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArchitectureDiagram, {}) })
  ] }) });
}
function ArchitectureDiagram() {
  const Block = ({
    ...
    title,
    sub
  }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-[180px] flex-col items-center rounded-xl border border-slate-200 bg-slate-50 px-5 py-4 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "h-5 w-5 text-slate-700" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm font-semibold text-slate-900", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-slate-500", children: sub })
  ] });
  const blocks = t.howItWorks.architecture;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-3 text-slate-400", children: blocks.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Block, { icon: ICONS[b.icon], title: b.title, sub: b.sub }),
    i < blocks.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-5 w-5" })
  ] }, b.title)) });
}
function DemoStrip() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "demo", className: "bg-slate-950 py-20 text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid gap-5 md:grid-cols-3", children: t.demoStrip.cards.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: common.liveDemoUrl,
        target: "_blank",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: IMAGES[c.image],
              alt: c.title,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-white/60", children: c.sub })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4 text-white/60 transition group-hover:translate-x-0.5 group-hover:text-white" })
          ] })
        ]
      },
      c.title
...
function Repos() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "repos", className: "border-b border-slate-200 bg-white py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeader,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 grid gap-5 md:grid-cols-3", children: t.repos.items.map((r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: common.repos[r2.repoKey],
        target: "_blank",
        rel: "noreferrer",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-slate-900", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { className: "h-5 w-5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-sm", children: r2.name })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 flex-1 text-sm leading-relaxed text-slate-600", children: r2.desc }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "mt-4 inline-flex items-center gap-1.5 text-sm font-medium text-slate-900", children: [
            t.repos.viewCta,
            " ",
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-slate-950 py-12 text-sm text-slate-400", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto grid max-w-7xl gap-8 px-6 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-white", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: common.brand })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 max-w-xs text-xs leading-relaxed text-slate-500", children: t.footer.tagline })
      ] }),
      t.footer.columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        FooterCol,
        {
          title: col.title,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto mt-10 max-w-7xl border-t border-white/10 px-6 pt-6 text-xs text-slate-500", children: [
      "© ",
...
function FooterCol({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-slate-300", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-3 space-y-2", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: l.internal ? /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: l.href, className: "hover:text-white", children: l.label }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        href: l.href,
