...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-46hwKjYm.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C-xSIkub.js").then((n) => n.r),
    import("./start-CdogWxZo.js"),
...
var ROUTER_BASEPATH = "experiment-lens";
var SERVER_FN_BASE = "/experiment-lens/_serverFn/";
